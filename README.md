...
**Hello Rails Back-End** is an app where I created a greeting API to be called in [this front-end project](https://github.com/asnganje/hello-react-front-end.git)
...
- **Send a greeting that is picked at random to an API**
...
```
- To clone the repository run this command - "https://github.com/asnganje/hello-rails-back-end.git"
...
- [ ] ***Display the specific country from where a greeting is coming from***
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
- **How was the API called in the react app?**
  ...
  react app to port 3001. That way, I was able to receive the data from the rails project.
